...
#include "/home/mad_flasher/.cache/wal/colors-wal-dwm.h"
...
static Key keys[] = {
	...
	{ MODKEY,						XK_a,      spawn,	   	   SHCMD("~/packages/android-studio-stable/android-studio/bin/./studio.sh") },
	...
	{ MODKEY|ShiftMask,				XK_m,	   spawn,	       SHCMD("java -jar ~/packages/minecraft/minecraft.jar") },
...
static Button buttons[] = {
	...
	{ ClkClientWin,         MODKEY|SUPERKEY, Button1,        movemouse,      {0} },
	{ ClkClientWin,         MODKEY,         Button2,        togglefloating, {0} },
	{ ClkClientWin,         MODKEY|SUPERKEY,         Button3,        resizemouse,    {0} },
